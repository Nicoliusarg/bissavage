...
// Helper: Wowhead CDN icon URL
function icon(key) {
  return "https://wow.zamimg.com/images/wow/icons/medium/" + key + ".jpg";
}

// Class icons (official class IDs 1..13)
const classes = {
  1:  { id: 1,  name: "Guerrero",               icon: icon("class_warrior") },
  2:  { id: 2,  name: "Paladin",                icon: icon("class_paladin") },
  3:  { id: 3,  name: "Cazador",                icon: icon("class_hunter") },
  4:  { id: 4,  name: "Picaro",                 icon: icon("class_rogue") },
  5:  { id: 5,  name: "Sacerdote",              icon: icon("class_priest") },
  6:  { id: 6,  name: "Caballero de la Muerte", icon: icon("class_deathknight") },
  7:  { id: 7,  name: "Chaman",                  icon: icon("class_shaman") },
...
// Race icons (core set; you can expand later)
const races = {
